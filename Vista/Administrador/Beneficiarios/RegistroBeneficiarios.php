...
<style>
    ...
    <form action="Tienda.php" id="contactus" method="post">
        ...
        ?>
        <center><h3>REGISTRAR BENEFICIARIOS</h3></center>
        <fieldset>
        ...
        <fieldset> 
            <input placeholder="Parentesco" type="text" name="Parentesco" tabindex="1" required>
        </fieldset>
        <fieldset>
            <input placeholder="Numero de Identificacion del Afiliado" type="text" name="NumIdentificacionAfiliado" tabindex="1" required>
        </fieldset>
