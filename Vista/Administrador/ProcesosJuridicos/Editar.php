...
<style>
    ...
    <div id="modi">
            ...
            <label for="staticEmxil" class="col-sm-2 col-form-label">Fecha de Inicio</label>
                <input type="text" id="exampleFormControlInput1" name="Fechain" value="<?= $user[1]?>" required>
            </div>
            <div class="form-group">
            ...
            <label for="staticEmail" class="col-sm-2 col-form-label">Descripcion</label>
                <input type="text" id="exampleFormControlInput1" name="Descripcion" value="<?= $user[3]?>" required>
            </div>
            <div class="form-group">
