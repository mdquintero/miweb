        ...
        <aside id="sidebar" class="js-sidebar">
            ...
            <div class="h-100">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a class="options" href="http://localhost/proyectotls/Vista/Secretario/ProcesosJuridicos/index.php">&nbsp; &nbsp; Procesos Jurídicos</a>
                </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a class="options" href="http://localhost/proyectotls/Vista/Secretario/Afiliados/index.php">&nbsp; &nbsp; Afiliados</a>
                </div>
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <div class="mb-3">
                    <center><h4>BIENVENIDO <?= $_SESSION['Nombres'] ?> </h4></center>
