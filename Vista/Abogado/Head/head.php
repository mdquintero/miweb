        ...
        <aside id="sidebar" class="js-sidebar">
            ...
            <div class="h-100">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a class="options" href="http://localhost/proyectotls/Vista/Abogado/ProcesosJuridicos/index.php">&nbsp; &nbsp; Procesos Jurídicos</a>
                </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a class="options" href="http://localhost/proyectotls/Vista/Abogado/Afiliados/index.php">&nbsp; &nbsp; Afiliados</a>
                </div>
