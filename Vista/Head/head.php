    ...
    <div class="wrapper">
        <aside id="sidebar" class="js-sidebar">
            ...
            <div class="h-100">
                ...
                <a class="options" href="../Usuarios/index.php">&nbsp; &nbsp; Abogados</a>
                </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a class="options" href="../ProcesosJuridicos/index.php">&nbsp; &nbsp; Procesos Jurídicos</a>
                </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a class="options" href="../Afiliados/index.php">&nbsp; &nbsp; Afiliados</a>
                </div>
