...
<head>
        <title>Perfil</title>
        <link rel="Website Icon" type="png" href="../image/logosolo.jpg">
    ...
    <div class="wrapper">
        <aside id="sidebar" class="js-sidebar">
            ...
            <div class="h-100">
                ...
                <a class="options" href="http://localhost/proyectotls/Vista/Administrador/Usuarios/index.php">&nbsp; &nbsp; Usuarios</a>
                </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a class="options" href="http://localhost/proyectotls/Vista/Administrador/ProcesosJuridicos/index.php">&nbsp; &nbsp; Procesos Jurídicos</a>
                </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a class="options" href="http://localhost/proyectotls/Vista/Administrador/Afiliados/index.php">&nbsp; &nbsp; Afiliados</a>
                </div>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="../Usuarios/informacion.php?id=<?= $_SESSION['Codigo'] ?>" class="dropdown-item">Perfil</a>
