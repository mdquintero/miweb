...
<tbody>
    <tr>
        ...
        <td>
            ...
            <a class="btn btn-success" data-bs-toggle="modal" data-bs-target="#confirmEditModal<?= $date[0] ?>">Editar</a>

        
            <div class="modal fade" id="confirmEditModal<?= $date[0] ?>" tabindex="-1" aria-labelledby="confirmEditLabel<?= $date[0] ?>" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="confirmEditLabel<?= $date[0] ?>">Confirmar Edición</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            ¿Estás seguro de que quieres editar el registro con número de radicado <?= $date[0] ?>?
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                            <a href="Editar.php?id=<?= $date[0] ?>" class="btn btn-success">Confirmar</a>
                        </div>
                    </div>
                </div>
            </div>
